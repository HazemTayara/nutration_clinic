        ...
        <div class="col-lg-8">
            <div class="form-card">
                <div class="form-header">
                    <h4 class="mb-0">
                        <i class="fas fa-user-plus ms-2"></i>معلومات المريض
                    </h4>
                    <p class="mb-0 mt-2 opacity-75">أدخل المعلومات الأساسية للمريض الجديد</p>
                </div>
                    ...
                    <form action="{{ route('patients.store') }}" method="POST" id="patientForm">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="gender-selector">
                                <div class="gender-option male {{ old('gender') == '1' ? 'selected' : '' }}" 
                                     onclick="selectGender(1)">
                                    <i class="fas fa-mars"></i>
                                    <h5 class="mb-1">ذكر</h5>
                                    <small class="text-muted">♂</small>
                                </div>
                                <div class="gender-option female {{ old('gender') == '0' ? 'selected' : '' }}" 
                        ...
                        <div class="alert alert-light border mb-4">
                            <div class="d-flex">
                                <i class="fas fa-lightbulb fa-2x ms-3" style="color: var(--accent);"></i>
                                <div>
                                    <strong>الخطوات التالية:</strong>
                                    <p class="mb-0 mt-1">بعد إنشاء المريض، ستتمكن من إضافة القياسات وإنشاء خطط غذائية مخصصة.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-between align-items-center border-top pt-4">
                            ...
                            <button type="submit" class="btn btn-primary btn-lg px-5">
                                <i class="fas fa-save ms-2"></i>إنشاء مريض
                            </button>
                        </div>
                    </form>
                </div>
